// Título da página (equivalente ao useEffect que definia document.title)
document.title = "Almeida Ferraz Advocacia";

// Acordeão de dúvidas frequentes — apenas um item aberto por vez
